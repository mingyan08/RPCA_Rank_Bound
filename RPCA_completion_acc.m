function [L, S, out] = RPCA_completion_acc(D, prox_S, prox_L, t, mask, para)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1: para.MAX_ITER
        ...
        errL(i)  = norm(L_new - L_old,'fro')/norm(L_old, 'fro');
        time(i)  = toc(timerval);
